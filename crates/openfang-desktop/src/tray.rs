...
pub fn setup_tray(app: &tauri::App) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let quit = MenuItem::with_id(app, "quit", "Quit EnterpriseClaw", true, None::<&str>)?;
    ...
    let _tray = TrayIconBuilder::new()
        .icon(tray_icon)
        .menu(&menu)
        .tooltip("EnterpriseClaw Agent OS")
                    ...
                    match crate::updater::check_for_update(&app_handle).await {
                        Ok(info) if info.available => {
                            ...
                            let _ = app_handle
                                ...
                                .body(format!(
                                    "Downloading EnterpriseClaw v{version}. App will restart shortly."
                                ))
                                .show();
                            // Perform install
                            if let Err(e) =
                        ...
                        Ok(_) => {
                            let _ = app_handle
                                ...
                                .builder()
                                .title("Up to Date")
                                .body("You're running the latest version of EnterpriseClaw.")
                                .show();
                        }
                        Err(e) => {
